...
Исходные данные:
     ...
     Построены 2 географически разнесённых ЦОД. Underlay взаимодействие организовано на основе протокола BGP при принципу I-E-I.
     ...
     Транзитная зона маршрутизации (SuperSpine) на схеме BGP (тип External) ASN: 65030
